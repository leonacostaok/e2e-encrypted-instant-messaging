            ...
            >
              Back to login
                ...
                <form onSubmit={handleConfirmMnemonic}>
                    ...
                    <MnemonicInput autoComplete="off" id={'confirm-mnemonic'} type="text" defaultValue=""
                                   value={confirmMnemonic} onChange={handleConfirmMnemonicChange}/>

...
const Login = () => {
    ...
    const handleRecoverSubmit = async (e: any) => {
        ...
        console.log('Estoy logueado after recovery')
    }
    ...
    const handleConfirmMnemonic = (e: any) => {
        e.preventDefault()
        console.log(loginMnemonic, confirmMnemonic)
            ...
            {loginScreen === LoginScreen.NORMAL ? (
              ...
              recover
                ...
                <form onSubmit={handleRecoverSubmit}>
                    ...
                    <p>Enter your 12 mnemonic words to recover your access and chat history.</p>
                    <MnemonicInput autoComplete="off" placeholder="Mnemonic..." type="text"
            ...
            <span
              ...
              Back to login
                ...
                <form onSubmit={handleContinueToConfirmation}>
                    ...
                    <MnemonicInput autoComplete="off" id={'show-mnemonic'} value={loginMnemonic} type="text"
                                   readOnly={true}/>
                ...
                loginScreen === LoginScreen.CONFIRM_MNEMONIC && (
                    <form onSubmit={handleConfirmMnemonic}>
                        ...
                        <MnemonicInput
                            ...
                            onChange={handleConfirmMnemonicChange}
                        />
                        <ButtonSubmit>Confirm</ButtonSubmit>
                        <p>
                            <span onClick={() => setLoginScreen(LoginScreen.SHOW_MNEMONIC)}>Go back</span> to check
                            again
                        </p>
                    </form>
                )

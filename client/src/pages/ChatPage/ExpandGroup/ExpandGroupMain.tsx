    ...
    <ExpandGroupMainBox>
      <HeaderGroupExpand>
        ...
        <DivIcon onClick={onHide}>
          <IconPortal srcIcon={IconExit} />
        </DivIcon>
      </HeaderGroupExpand>
      <DividerLight/>
      <BoxInfo>
        <Avatar>
          <IconPortal srcIcon={IconGroupDefault} widthIcon={'80px'} heightIcon={'80px'}/>
        </Avatar>
      ...
      <OptionList>
        <OptionItem>
          <OptionItemMain>
            <DivIcon>
              <IconPortal srcIcon={IconNotification} />
            </DivIcon>
        ...
        <OptionItem ref={optionMemberRef}>
          <OptionItemMain onClick={onToggleMembers}>
            <DivIcon>
              <IconPortal srcIcon={IconMembers} />
            </DivIcon>
            <Name>Members</Name>
